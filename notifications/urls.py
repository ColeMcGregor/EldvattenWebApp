...
urlpatterns = [
    ...
    path(
        "push/login-sync/",
        views.push_login_sync,
        name="push_login_sync",
    ),
    path(
        "push/public-key/",
    ...
    path(
        "push/enabled/",
        views.push_set_enabled,
        name="push_set_enabled",
    ),
    path(
        "push/active/",
        views.push_set_active,
        name="push_set_active",
    ),
    path(
        "push/pause/",
        views.push_pause,
    ...
    path(
        "push/pause/reset/",
        views.push_reset_pause,
        name="push_reset_pause",
    ),
]